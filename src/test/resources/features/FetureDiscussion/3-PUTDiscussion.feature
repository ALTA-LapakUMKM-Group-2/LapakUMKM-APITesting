...
Scenario: Put update data discussion
  Given Put update data request body discussion id 16
  ...
  Scenario: Put update data with invalid json
    Given Put update data request body with valid json 16
    When Send put update data discussion
  ...
  Scenario: Put update data invalid product id
    Given Put update data request body invalid product id 16
    When Send put update data discussion
    Then Status code should be 200 OK
    And Validate put update data resource json schema
  ...
  Scenario: Put update data with product id is blank
    Given Put update data with request body product id is blank 16
    When Send put update data discussion
    Then Status code should be 200 OK
    And Validate put update data resource json schema

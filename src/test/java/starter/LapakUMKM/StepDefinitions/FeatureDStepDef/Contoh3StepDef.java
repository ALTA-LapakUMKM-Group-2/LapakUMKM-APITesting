...
//        lapakUMKMCartTransaksi.getListUsers("users");
//    }
//
//    @When("Send get list user parameter")
//    public void sendGetListUserParameter() {
//        SerenityRest.when().get(lapakUMKMCartTransaksi.GET_LIST_USERS);
//    }
//
...
//        lapakUMKMCartTransaksi.setGetListUsersPage(id);
//    }
//    @When("Send get list user parameter page")
//    public void sendGetListUserParameterPage() {
//        SerenityRest.when().get(lapakUMKMCartTransaksi.GET_LIST_USERS_PAGE);
//    }
//

...
//import static starter.LapakUMKM.LapakUMKMCartTransaksi.TOKEN;
//
...
//        lapakUMKMCartTransaksi.setPostCreateUser("users");
//    }
//
//    @When("Send post create new user parameter")
//    public void sendPostCreateNewUserParameter() {
//        SerenityRest.when().post(lapakUMKMCartTransaksi.POST_CREATE_USER);
//    }
//
...
//     lapakUMKMCartTransaksi.setPostCreateUserNoAuth("users");
//    }
//
...
//        lapakUMKMCartTransaksi.setPostCreateUserNoName("users");
//    }
//
...
//        lapakUMKMCartTransaksi.setPostCreateUserNoEmail("users");
//    }
//
...
//        lapakUMKMCartTransaksi.setPostCreateUserNoGender("users");
//    }
//
...
//        lapakUMKMCartTransaksi.setPostCreateUserNostatus("users");
//    }
//
...
//        SerenityRest.when().post(lapakUMKMCartTransaksi.USERS);
//    }
//}

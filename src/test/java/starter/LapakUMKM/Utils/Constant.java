...
public class Constant {
    ...
    public static final String UPLOAD_IMAGE = DIR+"/src/docs/";
    ...
    public static final String JSON_SCHEMA_PRODUCTS = DIR+"/src/test/resources/JSON/JsonSchema/FeatureProducts/";
